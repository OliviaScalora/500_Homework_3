...
**b) Explain how logistic regression works around these issues.**
  ...
  ii. Present the regression equation for the logit model with multiple predictors.  
    1. Present the regression equation in both the logit form (i.e., with ln(𝑝1−𝑝) on the left-hand side of the equation) and the logistic form (𝑝=𝑃(𝑌=1) on the left-hand side of the equation).  
    a. In the formulas in (a) above, instead of writing 𝑌, 𝑥1… 𝑥𝑘, etc., write the names of the dependent and independent variables used in our actual model.  
